...
CREATE TABLE IF NOT EXISTS alarm_systems (
    ...
    last_status_changed_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS alarm_zones (
    ...
    zone_type INT DEFAULT 1,
    is_active BOOLEAN DEFAULT TRUE,
    description VARCHAR(255),
    zone_category VARCHAR(20) DEFAULT 'WIRELESS',
...
CREATE TABLE IF NOT EXISTS alert_logs (
    ...
    FOREIGN KEY (system_id) REFERENCES alarm_systems(id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- 5. User Systems Table
